...
var ReactGridLayout = function (_React$Component) {
  ...
  ReactGridLayout.prototype.onResize = function onResize(i, w, h, _ref5) {
    ...
    var placeholderL = newLayout ? (0, _utils.getLayoutItem)(newLayout, i) : (0, _utils.getLayoutItem)(oldLayout, i);
    ...
    if (newLayout) {
      for (var _i = 0, len = newLayout.length; _i < len; _i++) {
        var _l = newLayout[_i];
        if (_l.h + _l.y > maxRows) {
          newLayout = null;
          break;
        }
      }
