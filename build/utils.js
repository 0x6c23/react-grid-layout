 ...
 */
function compact(layout, compactType, cols, maxRows) {
 ...
 */
function compactItem(compareWith, l, compactType, cols, fullLayout, maxRows) {
 ...
 */
function synchronizeLayoutWithChildren(initialLayout, children, cols, maxRows, compactType) {
  ...
  var correctedLayout = compact(correctBounds(layout, { cols: cols }), compactType, cols, maxRows);
